...
if __name__ == "__main__":
    ...
    parser.add_argument('symbol', type=str, help="the stock symbol you want to download")
    parser.add_argument('start_year', type=str, help="the start year kline data you want to download")
    parser.add_argument('end_year', type=str, help="the end year kline data you want to download")
