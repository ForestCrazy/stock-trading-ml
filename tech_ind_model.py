...
print(f'start csv_to_dataset with {args.file_name}.csv')

# dataset

ohlcv_histories, technical_indicators, next_day_open_values, unscaled_y, y_normaliser = csv_to_dataset(args.file_name + '.csv')
